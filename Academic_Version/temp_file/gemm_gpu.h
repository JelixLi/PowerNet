...
namespace mdl {
    ...
    template <typename T>
    void InfoDevice<ArrayType<T> >::display(cl_device_id id,cl_device_info name,std::string str)
    {
        cl_int errNum;
        std::size_t paramValueSize;
    ...
    public:
        ...
        void EnqueueNDRangeKernel(int dim);
        ...
        void preComputeFloat(int M,int N,int K);b
